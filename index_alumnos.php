		...
		<div class="ialumnos_principal">
            ...
            <div id="bloque_1">
               <div id="mis_profesores" class="pulsable">
                  ...
                  <p id ="mis_profesores_1" class="pulsable"> <?php if ($profesores [0] != null) echo $profesores [0]; else echo '<br>'; ?> </p>
                  <p id ="mis_profesores_2" class="pulsable"> <?php if ($profesores [1] != null) echo $profesores [1]; else echo '<br>'; ?> </p>
                  <p id ="mis_profesores_3" class="pulsable"> <?php if ($profesores [2] != null) echo $profesores [2]; else echo '<br>'; ?> </p>
               </div>
            ...
            <div id="bloque_2">
               <div id="mis_cursos" class="pulsable">
                  ...
                  <p id ="mis_grupos_1" class="pulsable"> <?php if ($cursos [0] != null) echo $cursos [0]; else echo '<br>'; ?> </p>
                  <p id ="mis_grupos_2" class="pulsable"> <?php if ($cursos [1] != null) echo $cursos [1]; else echo '<br>'; ?> </p>
                  <p id ="mis_grupos_3" class="pulsable"> <?php if ($cursos [2] != null) echo $cursos [2]; else echo '<br>'; ?> </p>
               </div>
            ...
            <div id="bloque_3">
               <div id="mis_clases" class="pulsable">
                  ...
                  <div id="mis_clases_1" class="pulsable">
                     <p id ="mis_clases_1_nombre" class="pulsable">  <?php if ($clases [0] != null) echo $clases [0]; else echo '<br>'; ?> </p>
                     <p id ="mis_clases_1_horario" class="pulsable"> <?php if ($horas_clases [0] != null) echo $horas_clases [0]; else echo '<br>'; ?> </p>
                  </div>
                  <div id="mis_clases_2" class="pulsable">
                     <p id ="mis_clases_2_nombre" class="pulsable">  <?php if ($clases [1] != null) echo $clases [1]; else echo '<br>'; ?> </p>
                     <p id ="mis_clases_2_horario" class="pulsable"> <?php if ($horas_clases [1] != null) echo $horas_clases [1]; else echo '<br>'; ?> </p>
                  </div>
                  <div id="mis_clases_3" class="pulsable">
                     <p id ="mis_clases_3_nombre" class="pulsable">  <?php if ($clases [2] != null) echo $clases [2]; else echo '<br>'; ?> </p>
                     <p id ="mis_clases_3_horario" class="pulsable"> <?php if ($horas_clases [2] != null) echo $horas_clases [2]; else echo '<br>'; ?> </p>
                  </div>
               </div>
